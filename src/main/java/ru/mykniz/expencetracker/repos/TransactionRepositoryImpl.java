...
import ru.mykniz.expencetracker.domain.Transaction;
...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    private static final String SQL_CREATE = "INSERT INTO ET_TRANSACTIONS (TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE) VALUES(NEXTVAL('ET_TRANS_SEQ'), ?, ?, ?, ?, ?)";
